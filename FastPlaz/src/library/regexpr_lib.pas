...
type
  ...
  private
    ...
    function getGroupName(AIndex: integer): UnicodeString;
  ...
  public
    ...
    // Group
    property GroupCount: integer read GrpCount;
    property GroupName[AIndex:integer]: UnicodeString read getGroupName;
  end;
...
function TRegExpr.getGroupName(AIndex: integer): UnicodeString;
begin
  Result := GrpNames[AIndex];
end;
