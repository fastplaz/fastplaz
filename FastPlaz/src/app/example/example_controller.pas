...
begin
  ...
  while not Users.Data.EOF do
  begin
    AResponse.Contents.Add('<br>' + Users.Value['Host'].AsString);
...
begin
  ...
  case tags[0] of
    '$maincontent': begin
      ReplaceText:= ThemeUtil.RenderFromContent( @TagController, content_internal, template_file);
    end;
  end;
