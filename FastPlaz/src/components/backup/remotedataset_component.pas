...
type
  ...
  TRemoteDataset = class(TComponent)
  private
    FCount: integer;
    FData: TJSONArray;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          FDataset.Rows := D.Arrays['data'];
          FDataset.MetaData := D.Objects['metaData'];
          FDataset.OwnsData := False;
          FDataset.Open;
...
function TRemoteDataset.Open: boolean;
begin
  FIsSuccess := False;
